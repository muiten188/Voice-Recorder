...
export default class ThemeTextInput extends PureComponent {
    ...
    render() {
        ...
        let textInputContainerStyle = [commonStyle.textInput.textInputContainer, { borderBottomWidth: 1, borderBottomColor: color }, style]
            ...
            <Surface themeable={false} columnAlignStart style={[commonStyle.textInput.textInputColumnContainer2, { width: '100%' }, containerStyle]}>
                ...
                <Surface themeable={false} rowStart style={textInputContainerStyle}>
                    ...
                    <TextInput
                        ...
                        style={[commonStyle.textInput.input, { flex: 1, height: '100%' }, textInputStyle]}
                    />
                    {rightPart}
                </Surface>
                {!!hasError
