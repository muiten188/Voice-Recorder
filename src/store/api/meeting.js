...
export default {
    ...
    createMeeting: (audio_path, name, status, category_id) => {
        console.log('API createMeeting', { audio_path, name, status, category_id })
        return post('/api/v2/meeting', { audio_path, name, status, category_id })
    },
    ...
    getCategory: (page = 1, max_result = 200) => {
        return get('/api/v2/category', { page, max_result })
    }
}